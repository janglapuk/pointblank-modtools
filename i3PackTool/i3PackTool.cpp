// i3PackTool.cpp : Defines the class behaviors for the application.
//
...
// The one and only Ci3PackToolApp object

Ci3PackToolApp theApp;


// Ci3PackToolApp initialization
